...
const ArticlesErrorPage = ({error, reset}: ErrorPageProps) => {
  return (
    <div className="pt-7 text-center min-h-[calc(100vh_-_156px)]">
      ...
      <button onClick={() => reset()} className="bg-blue-500 cursor-pointer hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full">
        Try Agian
      </button>
