...
const UpdateCommentModal = ({ setOpen, text, commentId }: UpdateCommentModalProps) => {
    ...
    return (
      <div className="fixed top-0 left-0 bottom-0 right-0 z-10 bg-[rgb(0_0_0_/_0.9)] flex items-center justify-center">
        <div className="w-11/12 lg:w-2/4 bg-white rounded-lg p-3">
          ...
          <form onSubmit={formSubmitHandler}>
            ...
            <button
              type="submit"
              className="cursor-pointer bg-green-700 w-full text-white mt-2 p-1 text-xl rounded-lg hover:bg-green-900 transition"
            >
              Edit
            </button>
          </form>
